...
plot(fit1)
par(mfrow=c(2,2)) #multiple frames in a row by 2 by 2
par(mfrow=c(1,1))
plot(fit1, which=1)
#rresiduals should be normally distributed
...
#difference between normal and actual valuesa are called residuals
